    ...
    <div class="container mx-auto px-6">
      ...
      <div class="mt-16">
        <div class="flex justify-between">
          <div>
            <a class="px-5 py-1 pb-1.5 text-sm text-yellow-800 hover:bg-yellow-500 hover:text-white rounded-xl border border-yellow-500 cursor-pointer">عرض الكل</a>
          </div>
          <div class="border-b my-3 md:w-2/3 sm:w-2/4 border-gray-100"></div>
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
          <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
            ...
            <div class="">
              <h3 class="pt-3 pb-2 px-2 text-gray-700 text-right border-b">Chanel</h3>
